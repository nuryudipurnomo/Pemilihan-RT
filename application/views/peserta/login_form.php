        ...
        <div class="column">
          ...
          <div class=" ui form segment">
            ...
            <table align="center">
                ...
                <tr>
                  <td><label>Masukan Pass/No. ID Anda</label></td>
                  <td>&nbsp;</td>
                  <td>
                  <div class="field">
                    <div class="ui left icon input">
                      <i class="lock icon"></i>
                    <input type="password" name="password" class="login-field  login-field-password" id="password-3"  id="no_id" placeholder="Masukan no ID Anda" pattern="[0-9]{15}" required></td>
                    </div>
                  </div>
                </tr>
                 <tr>
